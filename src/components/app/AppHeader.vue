<template>
  <div>
      <div class=" relative bg-[url('/assets/images/mainPic.JPG')] h-90 bg-cover bg-center">
      ...
      <div class="flex flex-col absolute mt-30  left-1/2  w-full transform -translate-x-1/2 text-center">
